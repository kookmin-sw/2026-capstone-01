...
const FIREBASE_MESSAGING_SERVICE_WORKER_PATH = "/firebase/firebase-messaging-sw.js";
...
async function registerFirebaseMessagingServiceWorker(): Promise<ServiceWorkerRegistration> {
  ...
  const serviceWorkerUrl = new URL(FIREBASE_MESSAGING_SERVICE_WORKER_PATH, window.location.origin);
