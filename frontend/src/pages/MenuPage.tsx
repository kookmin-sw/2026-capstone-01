...
export default function MenuPage() {
  ...
  const koreanOrderMessage = useMemo(() => {
    ...
    const menuSentence = selectedItems
      .map((item) => `${item.original} ${toKoreanCount(item.quantity)}`)
      .join(", ");
      ...
      <div style={styles.phone}>
            ...
            <div style={styles.bottomBar}>
              {selectedItems.length > 0 && totalKRW > 0 ? (
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10, padding: "0 4px" }}>
                  <span style={{ fontSize: "0.8rem", color: "#9ca3af", fontWeight: 700 }}>{selectedItems.length} item{selectedItems.length > 1 ? "s" : ""} selected</span>
                  <span style={{ fontSize: "0.95rem", fontWeight: 900, color: "#111827" }}>₩{totalKRW.toLocaleString()}</span>
                </div>
              ) : null}
              <button
                type="button"
        ...
        {step === "order" ? (
          <section style={styles.orderSection}>
            {/* 1. Swipeable item review cards */}
            <div style={styles.orderCarousel} className="order-carousel">
            ...
            {editingNote ? (
              <div style={{ position: "relative", flexShrink: 0 }}>
                <textarea
                  ...
                  placeholder={"Any additional requests?\n(e.g. please no spicy, please extra napkins)"}
              ...
              >
                {orderNote.trim() ? `✏️  ${orderNote}` : "+ Add special request"}
              </button>
            )}
              ...
              <div style={styles.koreanActions}>
                ...
                >
                  <svg width="18" height="18" viewBox="0 0 64 64" fill="none" aria-hidden="true">
                    <path d="M26.6666 50.6663H13.3333V37.333M37.3333 13.333H50.6666V26.6663" stroke="rgba(255,255,255,0.8)" strokeWidth="5.33333" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </button>
                <button
                  type="button"
                ...
                >
                  {speaking ? (
                    <svg width="18" height="18" viewBox="0 0 64 64" fill="none" aria-hidden="true">
                      <path d="M21.3333 18.6667V45.3333" stroke="rgba(255,255,255,0.8)" strokeWidth="10.6667" strokeLinecap="round"/>
                      <path d="M42.6667 18.6667V45.3333" stroke="rgba(255,255,255,0.8)" strokeWidth="10.6667" strokeLinecap="round"/>
                    </svg>
                  ) : (
                    <svg width="18" height="18" viewBox="0 0 64 64" fill="none" aria-hidden="true">
                      <path d="M12 25.3333H22.6667L36 14.6667V49.3333L22.6667 38.6667H12V25.3333Z" stroke="rgba(255,255,255,0.8)" strokeWidth="5.33333" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M43 25.3333C46.6667 29.3333 46.6667 34.6667 43 38.6667M49 20C55.3333 26.6667 55.3333 37.3333 49 44" stroke="rgba(255,255,255,0.8)" strokeWidth="5.33333" strokeLinecap="round"/>
                    </svg>
                  )}
                </button>
              </div>
...
const styles: Record<string, CSSProperties> = {
  page: {
    ...
    fontFamily: "'Satoshi Variable', 'Satoshi', 'Apple SD Gothic Neo', 'Noto Sans KR', sans-serif",
    overflowX: "hidden",
  },
  ...
  uploadCopy: { margin: 0, color: "#6b7280", fontSize: "0.88rem", fontWeight: 700 },
  translateButton: {
    width: "100%",
    marginTop: "auto",
    border: "none",
  ...
  previewThumbWrapActive: { borderColor: "#01C0C0" },
  previewThumbButton: {
    width: "100%",
    height: "100%",
    padding: 0,
  ...
  categoryEmoji: { fontSize: "1rem", lineHeight: 1 },
  categoryLabel: {
    color: "#6b7280",
    fontSize: "0.72rem",
    fontWeight: 900,
  ...
  quantityCount: {
    ...
    minWidth: 48,
    textAlign: "center" as CSSProperties["textAlign"],
    borderLeft: "1px solid #e6f9f9",
    borderRight: "1px solid #e6f9f9",
    padding: "0 2px",
    lineHeight: "28px",
  },
  ...
  /* Korean card — dark surface, intentional */
  koreanCard: {
    flex: 1,
    minHeight: 160,
    maxHeight: 260,
  ...
  errorBody: { margin: 0, color: "#6b7280", lineHeight: 1.55 },
};
