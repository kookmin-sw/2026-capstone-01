...
import { getPlaceCategoryImageUrl } from "../../shared/data/placeCategoryImages";
...
export default function HomePage() {
  ...
  const [, setLocationLabel] = useState(DEFAULT_LOCATION_LABEL);
            ...
            {getDetailPhotos(selectedPlace, failedDetailPhotoUrls).length > 0 ? (
              <div style={styles.photoGallery}>
                {getDetailPhotos(selectedPlace, failedDetailPhotoUrls).slice(0, 3).map((photo, index) => (
                  <div key={photo} style={styles.galleryPhotoWrap}>
                    <img
                      src={photo}
