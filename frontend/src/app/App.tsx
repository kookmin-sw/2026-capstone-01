...
import { confirmTokenSaved, readToken, removeToken, saveToken } from "../shared/lib/tokens";
...
import type { AppToastDetail } from "../shared/lib/appToast";
import {
  clearPreferences,
  clonePreferences,
  defaultPreferences,
...
const DeleteAccountTermsPage = lazy(
  () => import("../pages/account/DeleteAccountTermsPage")
);
const WithdrawalPendingPage = lazy(
  () => import("../pages/account/WithdrawalPendingPage")
);
const HomePage = lazy(() => import("../pages/tour/HomePage"));
const MenuPage = lazy(() => import("../pages/menu/MenuPage"));
const MatePage = lazy(() => import("../pages/mate/MatePage"));
const ChatPage = lazy(() => import("../pages/chat/ChatPage"));
const ChatRoomPage = lazy(() => import("../pages/chat/ChatRoomPage"));
const MyPage = lazy(() => import("../pages/account/MyPage"));
const HelpInfoPage = lazy(() => import("../pages/account/HelpInfoPage"));
const UserFeedPage = lazy(() => import("../pages/feed/UserFeedPage"));
const SharedPlanPage = lazy(() => import("../pages/plan/SharedPlanPage"));
const PlaceholderPage = lazy(() => import("../pages/common/PlaceholderPage"));
const PlanSelectionPage = lazy(() => import("../pages/plan/PlanSelectionPage"));
const AiPlanDesignPage = lazy(() => import("../pages/plan/AiPlanDesignPage"));
const AiPlanResultPage = lazy(() => import("../pages/plan/AiPlanResultPage"));
const ManualPlanPage = lazy(() => import("../pages/plan/ManualPlanPage"));
